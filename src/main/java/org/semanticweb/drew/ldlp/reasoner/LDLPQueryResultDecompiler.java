...
public class LDLPQueryResultDecompiler {
	...
	List<Term> decompileTerms(List<Term> terms) {
	...
	Constant decompileConstant(Constant constant) {
	...
	protected Predicate decompilePredicate(Predicate predicate) {
